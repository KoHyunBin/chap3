...
public class LoggingAspect {
	final String publicMethod = "execution(public * annotation..*(..))"; //어노테이션 패키지의 모든 클래스중에 public 메서드들을 pointcut 설정
	@Before(publicMethod) //pointcut 설정 : annotation 패키지에 속한 클래스의 모든 public 메서드
	public void before() {
